...
export default function ClientTable() {
  ...
  const renderCell = React.useCallback((user: User, columnKey: React.Key) => {
    ...
    switch (columnKey) {
      ...
      case "actions":
        return (
          <div className="relative flex flex-col justify-center items-start gap-2 text-black">
    ...
    return (
      <div>
        <div className="flex flex-col gap-4">
          <div className="flex justify-between gap-3 items-end sms:flex-row flex-col">
            <Input
              isClearable
            ...
            <div className="flex gap-3">
              ...
              <Dropdown>
                ...
                >
                  {columns.map((column) => (
                    <DropdownItem key={column.uid} className="capitalize text-gray-400">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="text-center">
            <h1>{selectedCell?.contact_name}</h1>
            <h1>{selectedCell?.number}</h1>
          </div>
        ...
        <TableBody emptyContent={"No users found"} items={sortedItems}>
          {(item) => (
            <TableRow
              ...
              onClick={() => selectedCellInfo(item._id)}
            >
              {(columnKey) => (
